...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get usbConsoleCriticalConfirmTitle =>
      'Confirmación de comando crítico';

  @override
  String usbConsoleCriticalConfirmBody(String cmd, int ttl) {
    return '«$cmd» no se puede deshacer. ¿Continuar? (ventana de confirmación $ttl s)';
  }

  @override
  String get usbConsoleCriticalConfirmRun => 'Ejecutar';

  @override
  String usbConsoleCriticalCancelled(String cmd) {
    return 'Comando crítico no confirmado, no enviado: $cmd';
  }

  @override
  String usbConsoleErrTimeout(String detail) {
    return 'El dispositivo no respondió a tiempo. Comprueba el cable/puerto e inténtalo de nuevo. ($detail)';
  }

  @override
  String get usbConsoleErrClosed => 'Conexión USB cerrada.';

  @override
  String usbConsoleErrClosedReason(String detail) {
    return 'Conexión USB cerrada: $detail';
  }

  @override
  String get usbConsoleErrLineOverflow =>
      'El dispositivo envió datos muy largos sin salto de línea; puede que este puerto no sea un dispositivo SmartKraft. Conexión cerrada.';

  @override
  String usbConsoleUnmatchedReply(int id) {
    return 'Respuesta sin coincidencia · id=$id';
  }

  @override
  String get usbConsoleUnauthenticatedHint =>
      'Este comando requiere una sesión autenticada (`requires_auth=true`). La CLI USB no está autenticada; ejecútalo desde Mis dispositivos > [dispositivo] en una sesión BLE/WiFi emparejada.';

  @override
  String get usbConsoleNotConnected => 'No conectado';

  @override
  String get usbConsoleDetailUsage => 'Uso';

  @override
  String get usbConsoleDetailHelp => 'Detalles';
  ...
  String usbConsoleUnknownTopic(String target) {
    return 'No existe el tema/comando «$target». Lista:';
  }

  @override
  String usbConsoleHelpHintTopic(String example) {
    return 'Para ver los comandos de un tema: help $example';
  }

  @override
  String get usbConsoleHelpHintAll =>
      'Todos los comandos (incluidos ocultos): help all';

  @override
  String get usbConsoleNoUsageDefined =>
      'Este comando no tiene definición usage / help_block. Debe añadirse a su entrada sk_cli_command_t en el firmware.';

  @override
  String get usbConsoleRawJsonHide => 'ocultar JSON sin procesar';

  @override
  String get usbConsoleRawJsonShow => 'JSON sin procesar';
}
