...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get skapiTplMfrGeneric => 'Γενικό';

  @override
  String skapiTplMfrDeviceCount(int count) {
    return '$count συσκευές';
  }

  @override
  String get skapiTplBrandDisclaimer =>
      'Τα ονόματα και τα λογότυπα των εμπορικών σημάτων ανήκουν στους κατόχους τους και εμφανίζονται μόνο για την αναγνώριση συμβατών συσκευών. Η SmartKraft δεν συνδέεται ούτε υποστηρίζεται από αυτές τις εταιρείες.';
  ...
  String get usbConsoleUnauthenticatedHint =>
      'Αυτή η εντολή απαιτεί πιστοποιημένη συνεδρία (`requires_auth=true`). Το USB CLI δεν είναι πιστοποιημένο· εκτελέστε την από Οι συσκευές μου > [συσκευή] σε συζευγμένη συνεδρία BLE/WiFi.';

  @override
  String get usbConsoleNotConnected => 'Χωρίς σύνδεση';

  @override
  String get usbConsoleDetailUsage => 'Χρήση';

  @override
  String get usbConsoleDetailHelp => 'Λεπτομέρειες';
